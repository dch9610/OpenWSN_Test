...
This was done on 2022-01-19 11:45:19.431000.
*/
#ifndef __OPENCOAP_H
#define __OPENCOAP_H
...
typedef owerror_t (*callbackRx_cbt)(OpenMote* self, OpenQueueEntry_t* msg,
                                coap_header_iht*  coap_header,
                                coap_option_iht*  coap_incomingOptions,
                                coap_option_iht*  coap_outgoingOptions,
                                uint8_t*          coap_outgoingOptionsLen);
typedef void (*callbackSendDone_cbt)(OpenMote* self, OpenQueueEntry_t* msg,
                                      owerror_t error);
...
uint8_t opencoap_options_encode(OpenMote* self, OpenQueueEntry_t* msg,
    coap_option_iht* options, 
    uint8_t optionsLen, 
    coap_option_class_t class);
uint8_t opencoap_options_parse(OpenMote* self, uint8_t* buffer,
    uint8_t bufferLen,
    coap_option_iht* options,
    uint8_t* optionsLen);
