...
This was done on 2022-01-19 11:45:30.325000.
*/
...
*/
void ieee802154_prependHeader(OpenMote* self, OpenQueueEntry_t* msg,
                              uint8_t           frameType,
 ...
 packetfunctions_reserveHeaderSize(self, msg,TERMINATIONIE_LEN);
 ...
 packetfunctions_reserveHeaderSize(self, msg,TERMINATIONIE_LEN);
   ...
   if (frameType == IEEE154_TYPE_ACK) {
       timeCorrection = (int16_t)( ieee154e_getTimeCorrection(self));
 ...
 packetfunctions_reserveHeaderSize(self, msg,sizeof(uint16_t));
   ...
   if(securityEnabled){
 IEEE802154_security_prependAuxiliarySecurityHeader(self, msg);
   }

   // previousHop address (always 64-bit)
 packetfunctions_writeAddress(self, msg, idmanager_getMyID(self, ADDR_64B),OW_LITTLE_ENDIAN);
   // nextHop address
   if ( packetfunctions_isBroadcastMulticast(self, nextHop)) {
 ...
 packetfunctions_reserveHeaderSize(self, msg,sizeof(uint8_t));
      *((uint8_t*)(msg->payload)) = 0xFF;
      ...
      switch (nextHop->type) {
         case ADDR_16B:
         case ADDR_64B:
 packetfunctions_writeAddress(self, msg,nextHop,OW_LITTLE_ENDIAN);
            break;
         default:
 openserial_printCritical(self, COMPONENT_IEEE802154,ERR_WRONG_ADDR_TYPE,
 ...
 packetfunctions_writeAddress(self, msg, idmanager_getMyID(self, ADDR_PANID),OW_LITTLE_ENDIAN);
 ...
 packetfunctions_reserveHeaderSize(self, msg,sizeof(uint8_t));
   ...
   if (frameType==IEEE154_TYPE_ACK || packetfunctions_isBroadcastMulticast(self, nextHop)) {
...
*/
void ieee802154_retrieveHeader(OpenMote* self, OpenQueueEntry_t*      msg,
   ...
   switch ( (temp_8b >> IEEE154_FCF_DEST_ADDR_MODE ) & 0x03 ) {
      ...
      case IEEE154_ADDR_EXT:
         ...
         break;
      default:
 openserial_printError(self, COMPONENT_IEEE802154,ERR_IEEE154_UNSUPPORTED,
                               (errorparameter_t)1,
 ...
 openserial_printError(self, COMPONENT_IEEE802154,ERR_IEEE154_UNSUPPORTED,
   ...
   // panID
   if (ieee802514_header->headerLength>msg->length) { return; } // no more to read!
 packetfunctions_readAddress(self, ((uint8_t*)(msg->payload)+ieee802514_header->headerLength),
                               ADDR_PANID,
   ...
   switch (ieee802514_header->dest.type) {
      case ADDR_NONE:
         break;
      case ADDR_16B:
 packetfunctions_readAddress(self, 
 ...
 IEEE802154_security_retrieveAuxiliarySecurityHeader(self, msg,ieee802514_header);
   }
   ...
   if ( topology_isAcceptablePacket(self, ieee802514_header)==FALSE) {
