...
This was done on 2022-01-19 11:45:13.980000.
*/
...
// TX
#define DURATION_tt1 (self->ieee154e_vars).lastCapturedTime+TsTxOffset-delayTx-maxTxDataPrepare
#define DURATION_tt2 (self->ieee154e_vars).lastCapturedTime+TsTxOffset-delayTx
#define DURATION_tt3 (self->ieee154e_vars).lastCapturedTime+TsTxOffset-delayTx+wdRadioTx
#define DURATION_tt4 (self->ieee154e_vars).lastCapturedTime+wdDataDuration
#define DURATION_tt5 (self->ieee154e_vars).lastCapturedTime+TsTxAckDelay-TsShortGT-delayRx-maxRxAckPrepare
#define DURATION_tt6 (self->ieee154e_vars).lastCapturedTime+TsTxAckDelay-TsShortGT-delayRx
#define DURATION_tt7 (self->ieee154e_vars).lastCapturedTime+TsTxAckDelay+TsShortGT
#define DURATION_tt8 (self->ieee154e_vars).lastCapturedTime+wdAckDuration
// RX
#define DURATION_rt1 (self->ieee154e_vars).lastCapturedTime+TsTxOffset-TsLongGT-delayRx-maxRxDataPrepare
#define DURATION_rt2 (self->ieee154e_vars).lastCapturedTime+TsTxOffset-TsLongGT-delayRx
#define DURATION_rt3 (self->ieee154e_vars).lastCapturedTime+TsTxOffset+TsLongGT
#define DURATION_rt4 (self->ieee154e_vars).lastCapturedTime+wdDataDuration
#define DURATION_rt5 (self->ieee154e_vars).lastCapturedTime+TsTxAckDelay-delayTx-maxTxAckPrepare
#define DURATION_rt6 (self->ieee154e_vars).lastCapturedTime+TsTxAckDelay-delayTx
#define DURATION_rt7 (self->ieee154e_vars).lastCapturedTime+TsTxAckDelay-delayTx+wdRadioTx
#define DURATION_rt8 (self->ieee154e_vars).lastCapturedTime+wdAckDuration
// serialInhibit
#define DURATION_si  (self->ieee154e_vars).slotDuration-SERIALINHIBITGUARD
...
void ieee154e_getAsn(OpenMote* self, uint8_t* array);
...
uint16_t ieee154e_getTimeCorrection(OpenMote* self);
// events
