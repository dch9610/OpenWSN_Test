...
This was done on 2022-01-19 11:46:25.378000.
*/
...
void icmpv6echo_init(OpenMote* self) {
   ...
   (self->icmpv6echo_vars).isReplyEnabled = TRUE;
}
...
void icmpv6echo_receive(OpenMote* self, OpenQueueEntry_t* msg) {
 ...
 openserial_printInfo(self, COMPONENT_ICMPv6ECHO,ERR_RCVD_ECHO_REQUEST,
                               (errorparameter_t)0,
                               (errorparameter_t)0);
         if ((self->icmpv6echo_vars).isReplyEnabled){
...
void icmpv6echo_setIsReplyEnabled(OpenMote* self, bool isEnabled){
    (self->icmpv6echo_vars).isReplyEnabled = isEnabled;
}
