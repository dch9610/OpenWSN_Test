...
This was done on 2022-01-19 11:45:22.783000.
*/
/**
...
typedef void (*opentimers_cbt)(OpenMote* self, opentimers_id_t id);
...
opentimers_id_t opentimers_create(OpenMote* self, uint8_t timer_id, uint8_t task_priority);
