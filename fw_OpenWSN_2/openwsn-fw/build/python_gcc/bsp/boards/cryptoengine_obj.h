...
This was done on 2022-01-19 11:45:53.951000.
*/
/**
...
*/
owerror_t cryptoengine_aes_ccms_enc(OpenMote* self, uint8_t* a,
      uint8_t len_a,
      uint8_t* m,
      uint8_t* len_m,
      uint8_t* nonce,
...
\param[in] len_mac Length of the authentication tag.
*/
owerror_t cryptoengine_aes_ccms_dec(OpenMote* self, uint8_t* a,
      uint8_t len_a,
      uint8_t* m,
      uint8_t* len_m,
      uint8_t* nonce,
...
\param[in] key Buffer containing the secret key (16 octets).
 */
owerror_t cryptoengine_aes_ecb_enc(OpenMote* self, uint8_t buffer[16], uint8_t key[16]);
